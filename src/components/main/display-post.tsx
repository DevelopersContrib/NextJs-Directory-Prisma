    ...
    <>
      ...
      <div className="flex justify-between gap-x-8">
        ...
        <div className="relative">
          <button onClick={() => setOpenMenu((prev) => !prev)}>
            <IoEllipsisHorizontalCircle className="w-[33px] h-[33px] text-white/60" />
          </button>
      ...
      <div className="flex flex-col">
        <div className="flex items-center pb-4">
          <div className="flex items-center gap-x-4 w-[160px]">
            <MdOutlineDateRange className="w-[23px] h-[23px] text-white/60" />
            <h4 className="font-sans font-semibold text-base text-white/60">
              Date
            </h4>
          </div>
          <h4 className="font-sans font-semibold text-base text-white underline">
        ...
        <div className="flex items-center pt-4">
          <div className="flex items-center gap-x-4 w-[160px]">
            <CiFolderOn className="w-[23px] h-[23px] text-white/60" />
            <h4 className="font-sans font-semibold text-base text-white/60">
              Folder
            </h4>
          </div>
      ...
      <div className="flex flex-col gap-y-1 h-full w-full">
        <textarea
          ...
          className="bg-transparent border-none outline-none text-white font-normal text-base w-full h-full resize-none placeholder:text-white/60"
          name="body"
          autoFocus
        ></textarea>

        {errors?.body && (
          <p className="text-red-500 font-sans">{errors?.body}</p>
        )}
      </div>
    </>
  );
